    ...
    private static Command CreateBenchmarkCommand(dynamic globals)
    {
        ...
        var playersOption = new Option<string[]>("--ai")
        {
            Description = "AI for each player seat (e.g. --ai random greedy mcts nn). " +
                          "Available: random, greedy, mcts, nn, nn-placement, nn-main-game, nn-value, nn-value-placement, nn-value-main-game, nn-one-ply, nn-one-ply-placement, nn-one-ply-main-game, server-mcts, server-mcts-nn",
